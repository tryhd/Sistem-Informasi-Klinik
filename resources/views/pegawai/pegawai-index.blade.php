...
<!-- Content Wrapper. Contains page content -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            <td>
                <a href="{{ route('pegawai.create') }}"  type="button" class="btn btn-primary">Tambah Pegawai  <i class="fas fa-plus"></i></button></a>
            </td>
            ...
            <table id="example1" class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{{$row->tgl_lahir}}</td>
                    <td>{{$row->jabatan}}</td>
                    <td><img src="{{ asset('img/pegawai/'.$row->photo) }}" alt="user image" class="" width="30">
                    </td>
                    <td>   <a class="btn btn-info btn-sm" href="{{ route('pegawai.edit',$row->id) }}"> <i class="fas fa-pencil-alt">
                        </i>Edit</a>
